  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Xin chào! Tôi là trợ lý AI về Hành Trình Giọt Cà Phê ☕ – từ trồng trọt, sơ chế, rang xay đến pha chế và giá trị văn hóa. Bạn có câu hỏi gì về cà phê Việt Nam không?",
    },
  ]);
...
Câu hỏi: ${userMessage}`;
  ...
  const suggestedQuestions = [
    "Quy trình trồng cà phê như thế nào?",
    "Cà phê Việt Nam có đặc điểm gì?",
    "Vai trò của người trồng cà phê?",
    "Văn hóa cà phê Việt Nam ra sao?",
    "Các bước rang xay và pha chế cà phê?",
  ];
      ...
      {isOpen && (
        <div className="chat-window">
          ...
          <div className="chat-footer">
            <small>
              ☕ Trợ lý AI Hành Trình Giọt Cà Phê
            </small>
          </div>
        </div>
      )}
